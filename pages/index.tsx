...
const Home: NextPage = () => {
  ...
  const { data: isLottaryOperator } = useContractData(
    contract,
    "lotteryOperator"
  );
  useEffect(() => {
  ...
  return (
    <div className="bg-[#091b18] min-h-screen flex flex-col">
      ...
      <div className="flex-1">
        ...
        {/* The next box */}
        <div className="space-y-5 md:space-y-0 m-5 md:flex md:flex-row items-start justify-center md:space-x-5 max-w-6xl md:m-auto">
          ...
          <div className="stats-container space-y-2">
            <div className="stats-container">
              ...
              <div className="space-y-2 mt-5">
                <div className="flex items-center justify-between text-emerald-300 text-xs italic font-extrabold text-sm">
              ...
              <button
                ...
                onClick={handleClick}
                className="mt-5 w-full bg-gradient-to-br from-orange-500 to-emerald-600 py-5 rounded-md font-semibold text-white shadow-xl disabled:from-gray-600 disabled:to-gray-600 disabled:text-gray-100 disabled:cursor-not-allowed"
              >
      ...
      <footer className="border-t border-emerald-500/20 flex items-center text-white justify-between p-5">
        <p className="text-xs text-emerald-900 pl-5">
          DISCLAIMER: This is only a demo. Use this landing only with fake a
          account or fake ETH like MATIC or RINKEBY.
        </p>
      </footer>
    </div>
  );
